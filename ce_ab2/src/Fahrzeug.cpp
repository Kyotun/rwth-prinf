...
void Fahrzeug::vSimulieren(){
	...
	if(p_dZeit == dGlobaleZeit){
		...
		// wenn es ein Verhalten(Parken, Fahren) gibt, soll die Geschwindigkeit nach diesem Verhalten ausrechnet werden.
		// Fuer Parken soll das Fahrzeug auf die Startzeit warten.
		// Andersfalls wird die Teilstrecke ausgerechnet und Abschnitt bzw. Gesamtstrecke werden inkrementiert.
		if(p_pVerhalten){
